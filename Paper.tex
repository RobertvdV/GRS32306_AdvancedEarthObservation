...
The cloud processing is done on a vCPU (Intel Xeon E5 2686 v4) with two NVIDIA Tesla M60 GPU's and 240 GB of RAM.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm]{ViolinPlot2.png}
