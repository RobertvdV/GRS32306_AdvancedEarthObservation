...
\begin{figure}[h!]
    \centering
    \includegraphics[width=7cm]{DEM2x2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=7cm]{DEM2x2_scaled.png}
...
In this figure it is visible that the difference seems to be lower when the image count increases.

\begin{figure}[h!]
    \centering
    \includegraphics[width=8cm]{ScaledDemSubstraction.png}
