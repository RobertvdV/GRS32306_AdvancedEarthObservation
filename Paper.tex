...
A boxplot has been made to compare to the absolute values of the DEM's.
Large difference are visible, however when the scaled DEM's are plotted in a boxplot the difference appear to be minimal.
